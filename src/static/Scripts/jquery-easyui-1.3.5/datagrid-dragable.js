(function($){
    ...
    $.extend($.fn.datagrid.methods, {
        enableDrag: function(jq, options){
            return jq.each(function(){
                ...
                if(index >= 0){
                    var trs = opts.finder.getTr(this, index, "body", type);
                } else{
                    var trs = opts.finder.getTr(this, 0, "allbody", type);
                }
                trs.draggable({
                    disabled: false,
                    revert: true,
                    ...
                    onStopDrag: function(){
                        ...
                        dg.datagrid('enableDrag', {index: index, type: type});
                    ...
                    onDrop: function(e, source){
                        ...
                        function insert(){
                            ...
                            if(index < sourceIndex){
                                ...
                                dg.datagrid('enableDrag', {index: index - 1, type: type});
                            }
                        }
                    }
                });
